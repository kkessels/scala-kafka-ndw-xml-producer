...
import nu.ndw.{DirectionEnum, GroupOfLocations, LaneEnum, Linear, LinearElementByPoints, MeasuredOrDerivedDataTypeEnum, MeasurementSiteRecord, Point, SiteMeasurements, TrafficFlowType, TrafficSpeed, TrafficStatus, VehicleCharacteristics}
